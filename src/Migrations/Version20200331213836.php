 ...
 */
final class Version20200331213836 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__post AS SELECT id, title, body, image, tags FROM post');
        ...
        $this->addSql('INSERT INTO post (id, title, body, image, tags) SELECT id, title, body, image, tags FROM __temp__post');
    ...
    public function down(Schema $schema) : void
    {
        ...
        , body2 CLOB DEFAULT NULL COLLATE BINARY)');
